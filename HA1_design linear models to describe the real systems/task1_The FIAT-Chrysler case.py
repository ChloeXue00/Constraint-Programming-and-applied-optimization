...
x1 = m.addVar(vtype=GRB.CONTINUOUS, name="Panda")
x2 = m.addVar(vtype=GRB.CONTINUOUS, name="500")
x3 = m.addVar(vtype=GRB.CONTINUOUS, name="Musa")
x4 = m.addVar(vtype=GRB.CONTINUOUS, name="Giulia")
